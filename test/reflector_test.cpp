...
TEST(ReflectorTest, Reflector_can_transform_a_4x1_matrix) {
	...
	singular::Matrix< 4, 1 > m;
	m.fill(data);
	singular::Reflector< 4 > h(singular::Vector< double >(data, 4, 1));
...
TEST(ReflectorTest, Reflector_can_transform_a_1x3_matrix) {
	...
	singular::Matrix< 1, 3 > m;
	m.fill(data);
	singular::Reflector< 3 > h(singular::Vector< double >(data, 3, 1));
...
TEST(ReflectorTest, Reflector_can_transform_a_4x3_matrix_from_left) {
	...
	singular::Matrix< 4, 3 > m;
	m.fill(data);
	singular::Reflector< 4 > h(singular::Vector< double >(data, 4, 3));
...
TEST(ReflectorTest, 4x4_Reflector_can_transform_a_5x4_matrix_from_left) {
	...
	singular::Matrix< 5, 4 > m;
	m.fill(data);
	singular::Reflector< 5 > h(singular::Vector< double >(data + 5, 4, 4));
...
TEST(ReflectorTest, 3x3_Reflector_can_transform_a_5x4_matrix_from_right) {
	...
	singular::Matrix< 5, 4 > m;
	m.fill(data);
	singular::Reflector< 4 > h(singular::Vector< double >(data + 5, 3, 1));
